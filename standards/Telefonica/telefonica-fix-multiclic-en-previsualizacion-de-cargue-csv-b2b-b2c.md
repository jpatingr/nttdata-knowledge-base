...
Hallazgos evidenciados en pruebas:
- **CP_001 (B2B) y CP_004 (B2C):** ante clics rápidos repetidos en “Confirmar”/“Descartar”, la UI queda en estado bloqueado dentro de la previsualización (no permite salir).
...
- [ ] **Seguridad:** Mantener controles existentes de acceso/roles del módulo (no dexponer información adicional por mensajes).
...
## 5. Notas adicionales
- El comportamiento post-étito (redirigir, cerrar modal y refrescar grilla, etc.) debe mantenerse consistente con el flujo actual del portal.
